...
public class LauncherSearch extends ControlledPreferenceFragmentCompat {
    @Override
    public String getTitle() {
        return getString(R.string.custom_global_search);
    }
    ...
    public int getLayoutResource() {
        return R.xml.launcher_search_pref;
    }
    ...
    private final String mPrefKey = "launcher_global_search_launch";
