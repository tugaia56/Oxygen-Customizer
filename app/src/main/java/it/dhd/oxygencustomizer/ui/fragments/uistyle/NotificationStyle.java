...
public class NotificationStyle extends BaseFragment {
    ...
    private NotificationAdapter initNotifItems() {
		...
		notif_list.add(new NotificationModel("Transparent Fully", R.drawable.notif_transparent_fully));
        notif_list.add(new NotificationModel("Transparent Thin Outline", R.drawable.notif_transparent_fully_thin_outline));
